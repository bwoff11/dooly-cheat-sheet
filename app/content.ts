...
export const topDooleyItems: GlobalRankedItem[] = [
  ...
  { rank: 23, name: "Nitrogen Hammer", tier: "A", role: "Freeze burst", summary: "Every individual Freeze builds this medium weapon into a late carry.", bestIn: ["Launcher", "Critical", "The Core"], why: "The Hammer rewards quantity of Freeze triggers and brings another Freeze event itself. It is a named current Launcher endpoint, but without a second cast or multiple early Freezes it is merely a slow weapon.", condition: "At least two early Freeze events are forecast and support makes the second activation realistic." },

  { rank: 24, name: "Dino Saddle", tier: "B", role: "Vehicle Multicast", summary: "A Multicast capstone for the exact Vehicle selected by Thrusters.", bestIn: ["Launcher", "Dooltron", "Force Field"], why: "Saddle can double the right carry and create a winning late package, but its Diamond rarity and Vehicle requirement make it an opportunity rather than a plan to force.", condition: "A premium Vehicle target is already live, or Thrusters can convert the exact carry without weakening the board." },
