...
export const cores: CoreGuide[] = [
  ...
  },
  {
    ...
    summary:
      "The clearest tempo Core: frequent early Burn wins fights, while Plasma Rifle can convert that same event frequency into direct damage once stacks stop closing fights. Speed still matters—an eight-second Silver Core cannot be your opener.",
    plan:
      "Win early with cheap Burn and Blast Doors, bank gold, then use Gold access to convert into Plasma Rifle when the first cycle already produces repeated Burn events. Otherwise upgrade the Burn carry or prepare a control or one-shot exit.",
    pickWhen: ["Soldering Gun, Rocket Launcher, Flint Stones, or Blast Doors is already doing work.", "You have Haste or fast left-side triggers.", "Several Burn actions already occur before Plasma Rifle's actual first activation, creating a natural conversion.", "You can convert early wins into a large Day 6 shopping budget."],
    avoidWhen: ["Your Burn items are all slow and you have no Haste.", "Plasma Rifle would be the first real Burn payoff rather than a conversion for an existing engine.", "You are already losing to sustain and lack a faster late payoff."],
    board: [
      ...
      { label: "PLASMA RIFLE", kind: "payoff", size: 2 },
    ],
    boardLabels: { left: "LEFT · CHARGES IGNITION", right: "RIGHT · BURN SCALES; RIFLE CASHES OUT" },
    boardCaption: "Arrange cooldowns and equal-time items so Burn applications resolve before Plasma Rifle. The Rifle is Weapon / Tech—not a Burn item—and does not receive Ignition's right-side Burn gain.",
    builds: [
    ...
    buy: ["Plasma Rifle when 3+ pre-shot Burn events are already live", "Plasma Grenade / Rocket Launcher", "Blast Doors", "Metronome / Fiber Optics"],
    hold: ["Soldering Gun while Multicast creates useful Burn events", "Crit support for a scaled Plasma Rifle", "one defensive or control answer"],
    skip: ["unsupported Plasma Rifle with no pre-cast Burn frequency", "extra burners after Rifle needs speed, Crit, or survival", "slow Burn with no acceleration"],
    merchants: [
      { name: "Hef", why: "The focused Burn pool contains Plasma Rifle through its Burn-reference text plus the frequent Burn engines that actually scale it.", reroll: "At Gold access, reroll only when Rifle and multiple Burn upgrades are acceptable hits.", leave: "Leave when event frequency is solved and the missing piece is Rifle speed, Crit, or survival." },
      { name: "Aila", why: "Weapon-only stock can find or upgrade Plasma Rifle, Rocket Launcher, and other direct-damage conversions.", reroll: "Reroll while multiple weapon carries or upgrades improve the supported package—not for one naked Gold Rifle.", leave: "Leave when the board lacks Burn frequency or first-cycle timing rather than weapon quality." },
      { name: "Tok’s Clocks", why: "Haste and cooldown reduction solve Ignition’s slow baseline and help a scaled Rifle reach its second shot; Slow buys the time to get there.", reroll: "Reroll when Burn events and Rifle damage are sufficient but the payoff fires too late.", leave: "Skip when you still lack a meaningful Burn engine or supported carry." },
    ],
    timeline: [
      ...
      { phase: "Days 4–6", title: "Test the Rifle conversion", text: "Buy Plasma Rifle only when at least three Burn events can occur before its first cast and a real accelerator already exists. Route Hef or Aila only with multiple hits." },
      { phase: "Days 7+", title: "Scale and protect shot two", text: "Add Haste, Fiber, Crit, Multicast, and survival. If the supported Rifle still cannot beat sustain or control, exit into Chronobarrier, Flamethrower, or a one-shot." },
    ],
    pivots: ["Plasma Rifle converts Burn-event frequency into direct damage without discarding the engine.", "Flamethrower inherits Burn and Haste support when Rifle is unavailable or under-supported.", "Boulder, Soul of the District, or Chronobarrier can turn the early economy lead into a faster finish."],
    traps: ["Treating Plasma Rifle as a Burn item and expecting Ignition to grant it Burn.", "Buying the Gold Rifle before three or more Burn events can precede its first shot.", "Adding more burners after the Rifle’s real bottleneck becomes speed, Crit, protection, or Multicast."],
    patchChange: "Patch 16 changed the Core’s Burn from a flat 4 to 4 / 8 / 12. Plasma Rifle was unchanged in 16.1; its current 100 / 200 base and per-Burn scaling came from Patch 15.",
    sources: ["official", "expert", "bazaarDb", "plasmaRifle", "ignitionBuild"],
  },
  {
    id: "primal-core",
    name: "Primal Core",
...
export const coreDepthById: Record<string, CoreDepth> = {
  ...
  "ignition-core": {
    northStar: "Front-load enough Burn to beat decay, then convert the same event frequency into Plasma Rifle damage or maintain the stack while defense and control buy time.",
    bottleneck: "Burn loses one stack every half-second and deals half damage to Shield. Plasma Rifle fixes the conversion problem only when several Burn events occur before its first shot and speed makes shot two realistic.",
    firstBreakpoint: "Forecast at least three Burn applications before Plasma Rifle's actual first activation after speed effects—six seconds at base speed. Otherwise the Gold Rifle is only a medium 100-damage weapon.",
    exitRule: "Replace early Burn filler on Day 6. Prefer Rifle when event frequency is solved; abandon the route when neither the stack nor the supported Rifle threatens a kill inside two cycles.",
    itemRanks: [
    ...
    matchup: { favored: "Slow boards that allow Burn events to scale Plasma Rifle before its first and second shots.", respect: "Freeze on the Rifle, damage reduction, immediate-kill lines, and control that prevents shot two.", adapt: "Against Shield or healing, convert Burn frequency into Rifle or Drill damage. If Rifle already scales but fires too late, buy Haste, targeted Charge, Crit, or protection—not another burner." },
  },
  "primal-core": {
...
export const merchantDirectory = [
  ...
  { name: "Mittel", stock: "Medium items", reroll: "2g · 1 reroll", bestFor: "Core engines, Plasma Rifle conversions, midgame board density", rule: "The default best size shop when two or more Medium upgrades are live." },
  { name: "Aila", stock: "Weapons", reroll: "2g · 1 reroll", bestFor: "Critical, Weaponized, and supported Plasma Rifle carries", rule: "Visit for weapon quality, then leave once output is solved." },
  ...
  { name: "Hef", stock: "Burn items", reroll: "3g · 1 reroll", bestFor: "Ignition, Plasma Rifle, and focused Burn finishers", rule: "The narrow Burn shop; leave when cooldown or survival is the bottleneck." },
